...
let toCategoryGallery = ({ messenger_user_id, new_promo_name, new_promo_expiration_date, new_promo_claim_limit }) => ({ id: category_id, fields: category }) => {
  ...
  let send_images_url = createURL(
    ...
    { messenger_user_id, category_id, new_promo_name: encodeURIComponent(new_promo_name), new_promo_expiration_date: encodeURIComponent(new_promo_expiration_date), new_promo_claim_limit }
  );
