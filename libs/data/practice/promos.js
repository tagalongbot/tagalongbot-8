...
let getPracticePromo = async ({ practice_base_id, promo_id }) => {
...
let getPracticePromos = async ({ practice_base_id, view = 'Main View' }) => {
  let promosTable = getPromosTable(practice_base_id);
...
let createPracticePromo = async ({ practice_base_id, promo_data }) => {
  let promosTable = getPromosTable(practice_base_id);
...
let updatePracticePromo = async ({ practice_base_id, promo_data, promo }) => {
  let promosTable = getPromosTable(practice_base_id);
