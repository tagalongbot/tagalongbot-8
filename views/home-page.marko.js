...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/bevlbeauty$0.0.1/views/home-page.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h5 class=\"center-align\">Advertisment</h5><script type=\"text/javascript\" src=\"https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0-rc.2/js/materialize.min.js\"></script><script>\n      M.AutoInit();\n    </script>");
...
marko_template.meta = {
    id: "/bevlbeauty$0.0.1/views/home-page.marko",
    tags: [
