...
let sendServiceManufacturedPromos = async ({ query }, res) => {
  let { service_id, practice_id, practice_base_id } = query;
  ...
  let galleryData = promos.map(
    toPromosGallery({ service_id, practice_id, practice_base_id }, service)
  );
...
let createServicePromo = async ({ query }, res) => {
  ...
  let new_promo_practice_base_id = practice_base_id;

  let set_attributes = { new_promo_id, new_promo_service_id, new_promo_service_name, new_promo_type, new_promo_practice_id, new_promo_practice_base_id };
